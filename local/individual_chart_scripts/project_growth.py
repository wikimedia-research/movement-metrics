...
def main(argv):
	...
	df_wikidata = pd.read_csv(data_directory + '/data/wikidata_growth.csv', sep=',')
	df_wikipedia = pd.read_csv(data_directory + '/data/wikipedia_growth.csv', sep=',')
	df_commons = pd.read_csv(data_directory + '/data/commons_growth.csv', sep=',')
